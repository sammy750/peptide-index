...
regulatoryStatus: "Not approved by the FDA for any indication and not a licensed medicine. In April 2026 the FDA removed MOTS-c (free base and acetate) from 503A compounding Category 2. On July 23, 2026 the Pharmacy Compounding Advisory Committee (PCAC) voted 7-5 with 2 abstentions to recommend adding MOTS-c to the Section 503A bulk drug substances list (Docket No. FDA-2026-N-2979); obesity and osteoporosis were the indications under consideration. The recommendation ran counter to the FDA review team's own assessment. The vote is advisory and does not constitute approval — the FDA must still complete notice-and-comment rulemaking before any compounding is authorized. Not authorised as a medicine in the UK by the MHRA."
safety:
