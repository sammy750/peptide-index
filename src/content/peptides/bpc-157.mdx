...
regulatoryStatus: "Not FDA-approved for any use and no USP monograph. Added to the FDA's 503A interim Category 2 (\"significant safety risk\") list in 2023, then removed from Category 2 in April 2026 (~April 22) as a procedural/transitional step tied to a fresh review cycle — this is NOT approval or authorization to compound. On July 23, 2026 the FDA's Pharmacy Compounding Advisory Committee (PCAC) voted 8-6 with 1 abstention to recommend adding BPC-157 to the Section 503A bulk drug substances list, balloting the free base and acetate forms separately with the same result each time; the indication under consideration was ulcerative colitis (docket FDA-2025-N-6895). The committee voted against the recommendation of the FDA's own review team, which identified only a single small clinical trial (46 participants, rectal/enema administration). The vote is advisory and non-binding — formal notice-and-comment rulemaking is still required before licensed compounding, and even then the substance would be prescription-compounded, not OTC or FDA-approved."
safety:
...
references:
  ...
  - label: "Pentadecapeptide BPC 157 and growth hormone receptor expression (PMC)"
    ...
    source: PubMed
  - label: "PCAC approves four bulk drug substances for the 503A list (July 2026)"
    url: https://www.thefdalawblog.com/2026/07/peptide-l-wave-pcac-approves-four-bulk-drug-substances-for-the-503a-list/
    source: FDA Law Blog
  - label: "FDA advisory panel narrowly votes to allow compounding of unapproved peptides"
    url: https://www.statnews.com/2026/07/23/fda-panel-okays-peptides-compound-pharmacies-bpc-157-kpv/
    source: STAT
status: published
updated: 2026-07-27
---
